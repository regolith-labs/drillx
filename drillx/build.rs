...
fn main() {
    ...
    cc::Build::new()
        ...
        .include("cuda/equix/hashx/include")
        .include("cuda/equix/hashx/src")
        .file("cuda/equix/hashx/src/blake2.cu")
        .file("cuda/equix/hashx/src/compiler.cu")
        .file("cuda/equix/hashx/src/compiler_a64.cu")
        ...
        .file("cuda/equix/hashx/src/siphash_rng.cu")
        .file("cuda/equix/hashx/src/virtual_memory.cu")
